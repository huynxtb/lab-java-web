...
Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.
 Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo cons...">
    <meta property="og:image"
          content="http://cdn.simplesite.com/i/25/d7/284852684260562725/i284852689410723613._szw1280h1280_.jpg">
    ...
    <link rel="stylesheet" type="text/css"
          href="<c:url value='/template/web/About me_files/3623582.design.v25490.css'/> ">
    <link rel="canonical" href="http://us-123fashion.simplesite.com/410906237">
    <link rel="shortcut icon" href="data:image/x-icon;,">
    <script type="text/javascript" async=""
            src="<c:url value='/template/web/About me_files/analytics.js.download'/> "></script>
    <script async="" src="<c:url value='/template/web/About me_files/gtm.js.download'/> "></script>
    <script type="text/javascript"
            src="<c:url value='/template/web/About me_files/FrontendAppLocalePage.aspx'/>"></script>
    <script type="text/javascript" src="<c:url value='/template/web/About me_files/frontendApp.min.js.download'/> "></script>
...
<div class="container-fluid site-wrapper"> <!-- this is the Sheet -->
                                    ...
                                    <div class="img-simple span6 pull-left">
                                        <div class="image">
                                            <a rel="nofollow" data-ss="imagemodal"
                                               data-href="http://cdn.simplesite.com/i/25/d7/284852684260562725/i284852689410723613._szw1280h1280_.jpg"><img
                                                    src="<c:url value='/template/web/About me_files/i284852689410723613._szw480h1280_.jpg'/> "></a>
                                        </div>
                                    </div>
                                    <p><span><strong>Name:</strong> Susan Stratton</span></p>
                                    <p><span><strong>Age:</strong> 25</span></p>
 ...
 at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi.</span>
                                    </p></div>
                            </div>
                        </div>
    ...
    <li><a id="share-facebook" href="http://us-123fashion.simplesite.com/410906237#"><i
            class="icon-facebook-sign"></i><span>Share on Facebook</span></a></li>
    <li><a id="share-twitter" href="http://us-123fashion.simplesite.com/410906237#"><i
            class="icon-twitter-sign"></i><span>Share on Twitter</span></a></li>
    <li><a id="share-google-plus" href="http://us-123fashion.simplesite.com/410906237#"><i
        ...
        <div class="container">
            <div class="footer-info">
                <div class="footer-powered-by">
                    <a rel="nofollow"
                       href="http://www.simplesite.com/pages/receive.aspx?partnerkey=123i%3afooterbanner&amp;referercustomerid=10674181&amp;refererpageid=410906237">Created
                        with SimpleSite</a>
                </div>
            </div>
...
<div id="sm2-container" class="movieContainer high_performance"
    ...
    <embed name="sm2movie" id="sm2movie" src="/Images/sm297/soundmanager2_flash9.swf" quality="high"
           allowscriptaccess="always" bgcolor="#ffffff" pluginspage="www.macromedia.com/go/getflashplayer"
           title="JS/Flash audio component (SoundManager 2)" type="application/x-shockwave-flash" wmode="transparent"
           haspriority="true">
</div>
<div style="display: none; visibility: hidden;">
    ...
    <script type="text/javascript" src="./About me_files/conversion.js.download"></script>
    <iframe name="google_conversion_frame" title="Google conversion frame" width="300" height="13"
            src="./About me_files/saved_resource.html" frameborder="0" marginwidth="0" marginheight="0" vspace="0"
