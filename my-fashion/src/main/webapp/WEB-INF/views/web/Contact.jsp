...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<c:url value='/template/web/Contact_files/3623582.design.v25490.css'/> ">
    <link rel="canonical" href="http://us-123fashion.simplesite.com/410906953">
    <link rel="shortcut icon" href="data:image/x-icon;,">
    <script type="text/javascript" async="" src="<c:url value='/template/web/Contact_files/analytics.js.download'/> "></script>
    <script async="" src="<c:url value='/template/web/Contact_files/gtm.js.download'/> "></script>
    <script type="text/javascript" src="<c:url value='/template/web/Contact_files/FrontendAppLocalePage.aspx'/> "></script>
    <script type="text/javascript" src="<c:url value='/template/web/Contact_files/frontendApp.min.js.download'/> "></script>
...
<div class="container-fluid site-wrapper"> <!-- this is the Sheet -->
                                ...
                                <div class="content">
                                    ...
                                    <form>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="row-fluid">
                                                <div class="span12">
                                                    <textarea id="contactFormMessageText" name="text"
    ...
    <li><a id="share-facebook" href="http://us-123fashion.simplesite.com/410906953#"><i
            class="icon-facebook-sign"></i><span>Share on Facebook</span></a></li>
    <li><a id="share-twitter" href="http://us-123fashion.simplesite.com/410906953#"><i
            class="icon-twitter-sign"></i><span>Share on Twitter</span></a></li>
    <li><a id="share-google-plus" href="http://us-123fashion.simplesite.com/410906953#"><i
        ...
        <div class="container">
            <div class="footer-info">
                <div class="footer-powered-by">
                    <a rel="nofollow"
                       href="http://www.simplesite.com/pages/receive.aspx?partnerkey=123i%3afooterbanner&amp;referercustomerid=10674181&amp;refererpageid=410906953">Created
                        with SimpleSite</a>
                </div>
            </div>
